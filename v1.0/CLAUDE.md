...
4. `/d3-review` — collaborative review before pilot's manual edits, produce `review-notes.md`.
5. `/d3-recheck` — after pilot's manual edits, capture rationale, produce `recheck-learnings.md`.
